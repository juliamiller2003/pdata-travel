...
const BUILTIN: Record<string, { label: string; sub: string; items: TemplateItem[] }> = {
  ...
  beach: {
    ...
    items: [
      ...
      { name: "Rash guard / sun shirt",                     category: "Clothing"      },
      { name: "Sarong / beach towel",                       category: "Clothing"      },
      ...
      { name: "Sunscreen SPF 50+",                          category: "Toiletries"    },
      { name: "After-sun lotion / aloe vera",               category: "Toiletries"    },
      { name: "Insect repellent",                           category: "Toiletries"    },
      { name: "Phone + charger",                            category: "Electronics"   },
      { name: "Waterproof phone case / dry bag",            category: "Electronics"   },
      { name: "Underwater camera / GoPro",                  category: "Electronics"   },
      { name: "Rehydration sachets",                        category: "Health"        },
      { name: "Motion sickness meds (if boat trips)",       category: "Health"        },
      { name: "Antihistamines",                             category: "Health"        },
      { name: "Travel card / debit card",                   category: "Money"         },
      { name: "Local cash",                                 category: "Money"         },
      { name: "Waterproof day pack / dry bag",              category: "Other"         },
    ],
  },
  winter: {
    ...
    items: [
      ...
      { name: "Warm trousers / ski pants",                       category: "Clothing"   },
      { name: "Insulated jacket / down coat",                    category: "Clothing"   },
      { name: "Waterproof outer shell",                          category: "Clothing"   },
      { name: "Fleece / mid-layer",                              category: "Clothing"   },
      { name: "Woolen hat / beanie",                             category: "Clothing"   },
      ...
      { name: "Phone + charger",                                 category: "Electronics"},
      { name: "Power bank (keep warm — cold drains batteries)",  category: "Electronics"},
      { name: "Snow goggles / sunglasses",                       category: "Other"      },
      { name: "Cash + card",                                     category: "Money"      },
    ],
  },
  city: {
    ...
    items: [
      ...
      { name: "Jeans / trousers (1–2)",                            category: "Clothing"      },
      ...
      { name: "Basic meds (painkillers, antihistamines)",          category: "Health"        },
      { name: "Padlock (for luggage storage)",                     category: "Sleep & Hostel"},
      { name: "Day pack / tote bag",                               category: "Other"         },
      { name: "Travel card / debit card",                          category: "Money"         },
      { name: "Local cash",                                        category: "Money"         },
    ],
  },
  diving: {
    ...
    items: [
      ...
      { name: "Rash guard / dive skin",                         category: "Clothing"   },
      { name: "Wetsuit (3mm–5mm depending on water temp)",      category: "Clothing"   },
      { name: "Dive booties",                                   category: "Clothing"   },
      { name: "Sun hat + sunglasses",                           category: "Clothing"   },
      { name: "Sunscreen (reef-safe SPF 50+)",                  category: "Toiletries" },
      { name: "After-sun lotion",                               category: "Toiletries" },
      { name: "Underwater camera / GoPro + housing",            category: "Electronics"},
      { name: "Waterproof phone case",                          category: "Electronics"},
      { name: "Dive computer / watch (if owned)",               category: "Electronics"},
      { name: "Seasickness / motion sickness meds",             category: "Health"     },
      { name: "Rehydration sachets",                            category: "Health"     },
  ...
  festival: {
    ...
    items: [
      ...
      { name: "Rain poncho / waterproof jacket",              category: "Clothing"      },
      { name: "Warm layer / fleece (nights get cold)",        category: "Clothing"      },
      { name: "Sunscreen",                                    category: "Toiletries"    },
      { name: "Dry shampoo",                                  category: "Toiletries"    },
      { name: "Wet wipes",                                    category: "Toiletries"    },
      { name: "Hand sanitiser",                               category: "Toiletries"    },
      { name: "Phone + charger",                              category: "Electronics"   },
      { name: "Power bank (large capacity)",                  category: "Electronics"   },
      { name: "Painkillers + blister pads",                   category: "Health"        },
      { name: "Earplugs (sleeping in loud environment)",      category: "Sleep & Hostel"},
      { name: "Tent + sleeping bag (if camping)",             category: "Sleep & Hostel"},
      { name: "Reusable water bottle",                        category: "Other"         },
      { name: "Small backpack / bum bag",                     category: "Other"         },
      { name: "Cash (many stalls are cash only)",             category: "Money"         },
      { name: "Backup debit card",                            category: "Money"         },
    ],
  },
  digital_nomad: {
    ...
    items: [
      ...
      { name: "Laptop stand (portable / foldable)",             category: "Electronics"   },
      ...
      { name: "Cable organiser / pouch",                        category: "Electronics"   },
      { name: "T-shirts (3)",                                   category: "Clothing"      },
      ...
      { name: "Travel debit card with no foreign fees",         category: "Money"         },
      { name: "Emergency backup card",                          category: "Money"         },
