  ...
  return (
    <div className="mb-6 flex items-center justify-between gap-4 rounded-xl border border-[#cadede] bg-[#cadede]/20 dark:border-[#2a3f3f] dark:bg-[#2a3f3f]/40 px-4 py-3">
      <div className="flex items-center gap-3 min-w-0">
        ...
        <p className="text-sm text-[#1e2d2d] dark:text-[#cadede] min-w-0">
          <span className="font-semibold">Set up your travel preferences</span>
          <span className="text-[#1e2d2d]/70 dark:text-[#cadede]/70"> — help the AI suggest itineraries that match your style and pace.</span>
        </p>
      </div>
